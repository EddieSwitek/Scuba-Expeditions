' Eddie Switek
' CST 171 Fall 2018
' Chapter 7 Guided Program
' The Scuba Expedition app determines the location and scuba dives available and calculates the total dive team cost.
...
Public Class frmScuba
    ...
    Private Sub cboLocation_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboLocation.SelectedIndexChanged
        ' This event handler allows the user to enter the  location choice and then calls subprocedures to place 
        ' the dive types in the list.
    ...
    Private Sub btnDiveCost_Click(sender As Object, e As EventArgs) Handles btnDiveCost.Click
        ...
        ' displays the size of the team, the cost, and the length of the dive.
        ...
        ' If the number of people and the dive trip are valid, calcilate the cost.
    ...
    Private Sub frmScuba_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ' Hold the splash sceen for 5 seconds.
